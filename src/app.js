...
function bindPage(){
  ...
  document.querySelectorAll("[data-drag-item]").forEach(b=>{b.ondragstart=e=>e.dataTransfer.setData("text/plain",b.dataset.dragItem);b.onclick=()=>{const game=currentEscapeGame();game.interaction.held=b.dataset.dragItem;save();render()}});
