...
- 1차시 역사 학습, 퀴즈, 핵심 기록방 10개와 보너스방 2개로 구성된 분기형 역사 방탈출
- 신문 분류, 악보 조립, 다중 기록 선택, 곡조 연결, 도장, 음반 라벨, 다국어 페이지, 지도 배달, 조사 결론, 보존 도구 메커닉
- 1905/1908 자료 차이와 작사자 미결을 반영한 기록 신뢰도·힌트 감점·4개 엔딩
...
src/escape-game.js  12개 기록방 데이터, 메커닉, 점수·엔딩 엔진
src/styles.css      반응형 UI 디자인
tests/              방탈출 전체 완주 및 분기 자동 테스트
